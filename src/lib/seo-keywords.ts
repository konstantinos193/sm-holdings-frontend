...
export const seoKeywords: SEOKeywords = {
  global: {
    en: [
      ...
      'properties Thessaloniki',
      'rent Thessaloniki',
      'real estate Crete',
      'properties Crete',
      'rent Crete',
      'real estate Santorini',
    ...
    el: [
      ...
      'σπίτια Αθήνα',
      'ακίνητα Θεσσαλονίκη',
      'ενοικίαση Θεσσαλονίκη',
      'διαμερίσματα Θεσσαλονίκη',
      'ακίνητα Κρήτη',
      'ενοικίαση Κρήτη',
      'ακίνητα Σαντορίνη',
      'ενοικίαση Σαντορίνη',
  ...
  pages: {
    ...
    properties: {
      en: [
        ...
        'short-term rental Greece',
        'luxury villa Greece',
        'beachfront property Greece',
        'sea view apartment Greece',
        'penthouse Greece',
        'studio apartment Greece',
        'holiday home Greece',
        'commercial property Greece',
        'office space Greece',
        'retail space Greece',
        'land for sale Greece',
      ],
      el: [
        'ακίνητα Ελλάδα',
        ...
        'μακροχρόνια μίσθωση',
        'βραχυχρόνια μίσθωση',
        'πολυτελής βίλα Ελλάδα',
        'ακίνητο με θέα θάλασσα',
        'διαμέρισμα με θέα θάλασσα',
        'πενthouse Ελλάδα',
        'studio διαμέρισμα',
        'εξοχικό σπίτι',
        'εμπορικό ακίνητο',
